...
@EnableTransactionManagement//注解启用了事务管理功能
@SuppressWarnings({ "rawtypes", "unchecked" })
public class RedPigWebStore extends SpringBootServletInitializer  {
	
	@Override
    protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
        return application.sources(RedPigWebStore.class);
    }
	
	public static void main(String[] args) {
		SpringApplication.run(RedPigWebStore.class, args);
	}
