...
@Controller
public class RedPigWeixinLuckydrawViewAction extends BaseAction{


	@RequestMapping({ "/luckydraw/index" })
	public ModelAndView nuke(HttpServletRequest request,
		...
		ModelAndView mv = new RedPigJModelAndView("weixin/luckydraw/lottery.html",
