 ...
 */
@Controller
public class RedPigNukeOrderManagerAction extends BaseAction {
	 ...
	 * @return
	 */
	@RequestMapping({ "/nuke_order_list" })
	public ModelAndView nuke_order_list(HttpServletRequest request,
		...
		//秒杀id大于1为秒杀订单
		params.put("nuke_id_more_than_equal", 1);
