 ...
 */
@Controller
public class RedPigCollageOrderManagerAction extends BaseAction {
	 ...
	 * @return
	 */
	@RequestMapping({ "/collage_order_list" })
	public ModelAndView nuke_order_list(HttpServletRequest request,
		...
		ModelAndView mv = new RedPigJModelAndView("admin/blue/collage/collage_order_list.html",
		...
		//拼团id大于1为拼团订单
		params.put("collage_id_more_than_equal", 1);
	...
	@RequestMapping({ "/collage_order_view" })
	public ModelAndView order_view(HttpServletRequest request,
								   HttpServletResponse response, String id, String view_type) {
		ModelAndView mv = new RedPigJModelAndView("admin/blue/collage/collage_order_view.html",
				this.redPigSysConfigService.getSysConfig(),
				this.redPigUserConfigService.getUserConfig(), 0, request, response);
