...
import com.redpigmall.manage.buyer.tools.RedPigEvaluateTools;
 ...
 * 
 * <p>
 * Description: 1、统一注入需要使用的实体类,不会有任何影响,这些bean已经在spring容器中被构建出来,这里只是做一个注入
 * 2、避免重复调用注入,提高开发速度
 * </p>
 * 
 * <p>
...
public class BaseAction {
	...
	@Autowired
	protected RedPigRechargeCardService rechargeCardService;
	...
	@Autowired
	protected RedPigEvaluateTools evaluateTools;
	...
	@Autowired
	protected RedPigFavoriteService favService;
	...
	@Autowired
	protected RedPigSnapshotService snapshotService;
	@Autowired
