...
public class LuceneVo {
	...
	public static final String GOODS_PROPERTIES = "goods_properties";
	public static final String SELLER_ID = "seller_id";
	public static final String GROUP_AREAINFO_ID = "gainfo_id";
	public static final String F_SALE_TYPE = "f_sale_type";

	private String vo_gainfo_id;

	private String vo_goods_properties;
	private String vo_seller_id;
	...
	public String getVo_gainfo_id() {
		return this.vo_gainfo_id;
	}

	public void setVo_gainfo_id(String vo_gainfo_id) {
		this.vo_gainfo_id = vo_gainfo_id;
	}

	public String getVo_seller_id() {
		return this.vo_seller_id;
	}

	public void setVo_seller_id(String vo_seller_id) {
		this.vo_seller_id = vo_seller_id;
	}

	public String getVo_goods_properties() {
		return this.vo_goods_properties;
	}

	public void setVo_goods_properties(String vo_goods_properties) {
		this.vo_goods_properties = vo_goods_properties;
	}
