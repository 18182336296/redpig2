 ...
 * 
 * <p>
 * Description:图片资源FTP服务器管理类，可以使用任意多个FTP服务器管理图片，使用FTP上传、使用FTP服务器地址或者ip浏览图片，
 * 达到图片资源分布式管理
 * </p>
 * 
 * <p>
 ...
 * @date 2014-7-1
 * 
 * @version redpigmall_b2b2c v1.0 集群版
 */
