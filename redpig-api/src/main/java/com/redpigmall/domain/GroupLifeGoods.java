...
public class GroupLifeGoods extends IdEntity {
	...
	private String gg_phone;//手机号
	
	@ManyToOne(fetch = FetchType.LAZY)
	private GroupAreaInfo gg_gai;
	
	public String getGg_phone() {
		return this.gg_phone;
	}

	public void setGg_phone(String gg_phone) {
		this.gg_phone = gg_phone;
	}

	public GroupAreaInfo getGg_gai() {
		return this.gg_gai;
	}

	public void setGg_gai(GroupAreaInfo gg_gai) {
		this.gg_gai = gg_gai;
	}
	...
	public Boolean getGroup_recommend() {
	...
	public String getGg_describe() {
		return this.gg_describe;
	}

	public void setGg_describe(String gg_describe) {
		this.gg_describe = gg_describe;
	}
}
