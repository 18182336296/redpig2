...
public class ExpressCompanyCommon extends IdEntity {
	...
	public int getEcc_template_width() {
		return this.ecc_template_width;
	}
	...
	public int getEcc_template_heigh() {
		return this.ecc_template_heigh;
	}
	...
	public String getEcc_template_offset() {
		if (!CommUtil.null2String(this.ecc_template_offset).equals("")) {
			return this.ecc_template_offset;
		}
		return "";
	}
