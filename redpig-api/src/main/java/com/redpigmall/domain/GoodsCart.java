...
public class GoodsCart extends IdEntity {
	 ...
	 */
	@Column(columnDefinition = "LongText")
	private String combin_suit_info;// 套装购物车详情，使用json管理，{"suit_count":2,"plan_goods_price":"429","all_goods_price":"236.00","goods_list":[{"id":92,"price":25.0,"inventory":465765,"store_price":25.0,"name":"RAYLI 韩版时尚潮帽 百变女帽子围脖两用 可爱球球保暖毛线 HA048","img":"upload/system/self_goods/a7c137ef-0933-4c72-8be6-e7eb7fdfb3c7.jpg_small.jpg","url":"http://localhost/goods_92.htm"}],"suit_all_price":"429.00"}
	...
	private int remain_count;//可买数量=限购数量(goods.goods_limit_count)-已购数量(this.count)
