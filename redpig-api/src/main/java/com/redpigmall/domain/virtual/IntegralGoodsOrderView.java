...
public class IntegralGoodsOrderView {
	...
	/** 积分商品名称*/
	private String igo_goods_name;
	/** 积分商品id*/
	private Long igo_goods_id;
	/** 所在积分兑换订单的id*/
	private Long igo_order_id;
	/** 积分商品图片的地址信息*/
	private String igo_goods_img;

	public Long getIgo_goods_id() {
		return this.igo_goods_id;
	}
