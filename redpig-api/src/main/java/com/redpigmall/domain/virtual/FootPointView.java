...
public class FootPointView
{
  ...
  {
    return this.fpv_goods_class_id;
  }
  ...
  {
    return this.fpv_goods_class_name;
  }
  ...
  {
    return this.fpv_goods_img_path;
  }
