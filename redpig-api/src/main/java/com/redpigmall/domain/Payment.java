...
public class Payment extends IdEntity {
	...
	private String unionpay_merId;//银联支付
...
//	private List<OrderForm> ofs = new ArrayList<OrderForm>();// 对应的订单，反向映射，便于获取订单信息
	...
	public String getUnionpay_merId() {
		return this.unionpay_merId;
	}

	public void setUnionpay_merId(String unionpay_merId) {
		this.unionpay_merId = unionpay_merId;
	}
