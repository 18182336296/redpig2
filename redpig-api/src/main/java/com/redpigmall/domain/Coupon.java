...
public class Coupon extends IdEntity {
	...
	private int coupon_limit;//领取购物券等级限制
	@Column(columnDefinition = "int default 0")
	private int status;//购物券状态
	private int coupon_surplus_amount;//购物券剩余数量

	public int getCoupon_surplus_amount() {
		return this.coupon_surplus_amount;
	}

	public void setCoupon_surplus_amount(int coupon_surplus_amount) {
		this.coupon_surplus_amount = coupon_surplus_amount;
	}
