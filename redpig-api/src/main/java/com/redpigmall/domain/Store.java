...
public class Store extends IdEntity {
	...
	private String store_service_info;//店铺服务
	@Column(columnDefinition = "LongText")
	private String store_wap_decorate_info;//店铺手机端装修
	@Column(columnDefinition = "int default 0")
	private Integer code_type = 0;//商事制度
	private String social_credit_code;//社会信用代码号
	...
	@Column(columnDefinition = "int default 0")
	private Integer store_status;// 店铺状态，0为未提交开店申请，5公司等待信息审核,6公司信息审核失败,10店铺等待信息审核,11店铺信息审核失败，15为正常营业（审核成功）,20违规关闭，25到期关闭,26,到期后申请续费
	...
	@Column(columnDefinition = "LongText")
	private String gc_detail_info;// 店铺经营类，[{"gc_list":[2, 8, 3, 6, 7,5],"m_id":1}]，当店铺申请店铺时选择了详细类目，商家发布商品时只可选择所有的详细类目
	@ManyToOne(fetch = FetchType.LAZY)
	...
	@Column(columnDefinition = "int default 0")
	private Integer store_credit =0 ;// 店铺等级，根据好评数累加
	@Column(columnDefinition = "LongText")
	...
	public String getStore_wap_decorate_info() {
		return this.store_wap_decorate_info;
	}

	public void setStore_wap_decorate_info(String store_wap_decorate_info) {
		this.store_wap_decorate_info = store_wap_decorate_info;
	}

	public String getStore_service_info() {
		return this.store_service_info;
	}

	public void setStore_service_info(String store_service_info) {
