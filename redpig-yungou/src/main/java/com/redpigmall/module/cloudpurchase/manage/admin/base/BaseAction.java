package com.redpigmall.module.cloudpurchase.manage.admin.base;
...
public class BaseAction {
	...
	@Autowired
	protected RedPigCloudPurchaseRecordService redPigCloudPurchaseRecordService;
	...
	@Autowired
	protected RedPigCloudPurchaseGoodsService cloudPurchaseGoodsService;

	@Autowired
	protected RedPigCloudPurchaseRecordService cloudPurchaseRecord;
	...
	@Autowired
	protected RedPigCloudPurchaseClassService cloudPurchaseClassService;

	@Autowired
	protected RedPigCloudPurchaseLotteryService cloudPurchaseLotteryService;

	@Autowired
	protected RedPigCloudPurchaseCartService cloudPurchaseCartService;
